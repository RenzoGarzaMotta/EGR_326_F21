...
uint32_t ST7735_DrawString(uint16_t x, uint16_t y, uint8_t size ,char *pt, int16_t textColor){
  uint32_t count = 0;
  if(y>15) return 0;
  while(*pt){
...
void ST7735_OutUDec(uint32_t n){
  ...
  ST7735_DrawString(StX, StY, 1, Message, StTextColor);
...
void ST7735_OutChar(char ch){
  if((ch == 10) || (ch == 13) || (ch == 27)){
    ...
    ST7735_DrawString(0,StY,1,"                     ",StTextColor);
    return;
  }
