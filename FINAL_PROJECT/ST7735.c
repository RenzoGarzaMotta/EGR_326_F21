...
static const uint8_t Font[] = {
  ...
  0x3E, 0x5B, 0x4F, 0x5B, 0x3E,// > in a square
...
uint32_t ST7735_DrawString(uint16_t x, uint16_t y, uint8_t size ,char *pt, int16_t textColor, uint16_t bgColor, uint8_t invert){
  uint32_t count = 0;
  if(invert == 1){
      bgColor = ~textColor;
  }
...
void ST7735_OutUDec(uint32_t n){
  ...
  ST7735_DrawString(StX, StY, 1, Message, StTextColor, ST7735_BLACK, 0);
...
void ST7735_OutChar(char ch){
  if((ch == 10) || (ch == 13) || (ch == 27)){
    ...
    ST7735_DrawString(0,StY,1,"                     ",StTextColor, ST7735_BLACK, 0);
    return;
  }
